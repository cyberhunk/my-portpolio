...
// crousel
const prevBtn = document.querySelector("#right-prev-btn");
const nextBtn = document.querySelector("#left-prev-btn");
...
prevBtn.addEventListener("click", () => {
  console.log("left-prev-btn clicked");
...
function sendEmail() {
  ...
  Email.send({
    ...
    Username: "satyamvishwakarma1819@gmail.com",
    Password: " #",
    To: "satyamvishwakrma1819@gmail.com",
    From: "satyamvishwakrma@gmail.com",
    Subject: sub.value,
    Body: bodyMesg,
  }).then((message) =>
